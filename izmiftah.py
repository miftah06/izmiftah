...
def handle_prompt(message):
    ...
    if len(args) == 5:
        keyword_file1 = args[0]
        keyword_file2 = args[1]
        output_file = args[2]
        ...
        bot.send_message(message.chat.id/"Format prompt tidak valid. Gunakan format /buatlah keyword_file1/keyword_file2/output_file/command_option/specification_option/prompt_type/additional_input")
